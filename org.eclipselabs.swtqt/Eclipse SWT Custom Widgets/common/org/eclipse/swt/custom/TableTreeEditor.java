...
/**
 * 
 * A TableTreeEditor is a manager for a Control that appears above a cell in a
 * TableTree and tracks with the moving and resizing of that cell. It can be
 * used to display a text widget above a cell in a TableTree so that the user
 * can edit the contents of that cell. It can also be used to display a button
 * that can launch a dialog for modifying the contents of the associated cell.
 * 
 * <p>
 * Here is an example of using a TableTreeEditor: <code><pre>
...
public class TableTreeEditor extends ControlEditor {
	 ...
	 * 
	 * @param tableTree
	 *            the TableTree Control above which this editor will be
	 *            displayed
	 * 
	 */
	...
	/**
	 * Removes all associations between the TableTreeEditor and the cell in the
	 * table tree. The TableTree and the editor Control are <b>not</b> disposed.
	 */
	@Override
	public void dispose() {
	...
	/**
	 * Returns the TableTreeItem for the row of the cell being tracked by this
	 * editor.
	 * 
	 * @return the TableTreeItem for the row of the cell being tracked by this
	 *         editor
	 */
