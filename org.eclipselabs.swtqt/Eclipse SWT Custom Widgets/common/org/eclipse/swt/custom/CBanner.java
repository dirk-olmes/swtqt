...
public class CBanner extends Composite {
	 ...
	 * control is optional. Setting the bottom control to null will remove it
	 * from the banner - however, the creator of the control must dispose of the
	 * control.
	 * 
	 * @param control
	 *            the control to be displayed on the bottom or null
	 * 
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been
	 ...
	 * 
	 * @param control
	 *            the control to be displayed on the left or null
	 * 
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been
	 ...
	 * control is optional. Setting the right control to null will remove it
	 * from the banner - however, the creator of the control must dispose of the
	 * control.
	 * 
	 * @param control
	 *            the control to be displayed on the right or null
	 * 
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been
	...
	/**
	 * Set the minimum height of the control that appears on the right side of
	 * the banner.
	 * 
	 * @param size
	 *            the minimum size of the control on the right
	 * 
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been
	...
	/**
	 * Set the width of the control that appears on the right side of the
	 * banner.
	 * 
	 * @param width
	 *            the width of the control on the right
	 * 
	 * @exception SWTException
	 *                <ul>
	 *                <li>ERROR_WIDGET_DISPOSED - if the receiver has been
	 ...
	 * 
	 * @param simple
	 *            <code>true</code> if the CBanner should render itself in a
