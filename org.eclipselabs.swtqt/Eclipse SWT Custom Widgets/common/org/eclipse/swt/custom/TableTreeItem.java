...
public class TableTreeItem extends Item {
	 ...
	 * <code>TableTree</code>) and a style value describing its behavior and
	...
	/**
	 * Constructs a new instance of this class given its parent (which must be a
	 * <code>TableTree</code>, a style value describing its behavior and
	...
	/**
	 * Constructs a new instance of this class given its parent (which must be a
	 * <code>TableTreeItem</code>) and a style value describing its behavior and
	 * appearance. The item is added to the end of the items maintained by its
	 * parent.
	 * <p>
	 * The style value is either one of the style constants defined in class
	...
	/**
	 * Constructs a new instance of this class given its parent (which must be a
	 * <code>TableTreeItem</code>), a style value describing its behavior and
	 * appearance, and the index at which to place it in the items maintained by
	 * its parent.
	 * <p>
	 * The style value is either one of the style constants defined in class
	...
	TableTreeItem(TableTree parent, TableTreeItem parentItem, int style, int index) {
		...
		if (parentItem == null) {
			...
			addCheck();
			/*
			 * Feature in the Table. The table uses the first image that is
			 * inserted into the table to size the table rows. If the user is
			 * allowed to insert the first image, this will cause the +/- images
			 * to be scaled. The fix is to insert a dummy image to force the
			 * size.
			 */
	 ...
	 * <p>
	 * The image in column 0 is reserved for the [+] and [-] images of the tree,
	 * therefore getImage(0) will return null.
	 * 
	 ...
	 * <p>
	 * Indexing is zero based. The image can be null. The image in column 0 is
	 * reserved for the [+] and [-] images of the tree, therefore getImage(0)
	 * will return null. Return null if the index is out of range.
	 * 
	 * @param index
	 ...
	 * <code>TableTreeItem</code> or null when the receiver is a root.
	 * 
