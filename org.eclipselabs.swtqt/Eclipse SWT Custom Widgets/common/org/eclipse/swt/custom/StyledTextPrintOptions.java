 ...
 * <p>
 * The following example prints a right aligned page number in the footer, sets
 * the job name to "Example" and prints line background colors but no other
 * formatting:
 * </p>
 * 
 * <pre>
...
public class StyledTextPrintOptions {
	/**
	 * Page number placeholder constant for use in <code>header</code> and
	 * <code>footer</code>. Value is <code>&lt;page&gt;</code>
	 */
	public static final String PAGE_TAG = "<page>";
	/**
	 * Separator constant for use in <code>header</code> and <code>footer</code>
	 * . Value is <code>\t</code>
	 */
	 ...
	 * <code>StyledTextPrintOptions.PAGE_TAG</code>). The three regions are left
	 * aligned, centered and right aligned. They are separated by a tab
