...
/**
 * A TableCursor provides a way for the user to navigate around a Table using
 * the keyboard. It also provides a mechanism for selecting an individual cell
 * in a table.
 * 
 * <p>
 * Here is an example of using a TableCursor to navigate to a cell and then edit
 * it.
 * 
 * <code><pre>
 ...
 * @since 2.0
 * 
 * @see <a href="http://www.eclipse.org/swt/snippets/#tablecursor">TableCursor
 *      snippets</a>
...
public class TableCursor extends Canvas {
	...
	/**
	 * Constructs a new instance of this class given its parent table and a
	...
	/**
	 * Positions the TableCursor over the cell at the given row and column in
	 * the parent table.
	 * 
	 * @param row
