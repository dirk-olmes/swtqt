 ...
 * the list.
 * <p>
 * CCombo was written to work around certain limitations in the native combo
 * box. Specifically, on win32, the height of a CCombo can be set; attempts to
 * set the height of a Combo are ignored. CCombo can be used anywhere that
 ...
 * requirement that CCombo look or behave the same as the native combo box.
 * </p>
 * <p>
