 ...
 * 
 * @deprecated As of Eclipse 2.1, use ProgressBar with the style
 *             SWT.INDETERMINATE
 * 
 *             <dl>
 *             <dt><b>Styles:</b>
 *             <dd>VERTICAL, HORIZONTAL, BORDER
 *             </dl>
 * 
...
public class AnimatedProgress extends Canvas {
	...
	/**
	 * Stop the animation if it is not already stopped and reset the
	 * presentation to a blank appearance.
	 * 
	 * @exception SWTException
	 *                <ul>
