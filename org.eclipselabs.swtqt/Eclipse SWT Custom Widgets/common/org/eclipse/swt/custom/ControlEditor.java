...
public class ControlEditor {
	 ...
	 * Allowed values are SWT.LEFT, SWT.RIGHT and SWT.CENTER. The default value
	 * is SWT.CENTER.
	 */
	public int horizontalAlignment = SWT.CENTER;

	/**
	 * Specifies whether the editor should be sized to use the entire width of
	 * the control. True means resize the editor to the same width as the cell.
	 * False means do not adjust the width of the editor. The default value is
	 * false.
	 */
	...
	/**
	 * Specifies how the editor should be aligned relative to the control.
	 * Allowed values are SWT.TOP, SWT.BOTTOM and SWT.CENTER. The default value
	 * is SWT.CENTER.
	 */
	 ...
	 * underlying control. False means do not adjust the height of the editor.
	...
	/**
	 * Lays out the control within the underlying composite. This method should
	 * be called after changing one or more fields to force the Editor to
	 * resize.
	 * 
	 * @since 2.1
	 */
