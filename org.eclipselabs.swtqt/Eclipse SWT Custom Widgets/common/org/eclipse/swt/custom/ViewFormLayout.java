	...
	protected void layout(Composite composite, boolean flushCache) {
		...
		if (form.separateTopCenter || minTopWidth > rect.width) {
			...
			if (center != null && !center.isDisposed()) {
				...
				center.setBounds(rect.x + rect.width - form.marginWidth - form.highlight - centerSize.x, y,
			...
			if (left != null && !left.isDisposed()) {
				top = true;
				Rectangle trim = left instanceof Composite ? ((Composite) left).computeTrim(0, 0, 0, 0)
		...
		if (content != null && !content.isDisposed()) {
			...
			content.setBounds(rect.x + form.marginWidth + form.highlight, y, rect.width - 2 * form.marginWidth - 2
					* form.highlight, rect.y + rect.height - y - form.marginHeight - form.highlight);
		}
