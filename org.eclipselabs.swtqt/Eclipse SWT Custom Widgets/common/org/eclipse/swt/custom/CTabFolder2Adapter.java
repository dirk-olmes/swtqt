 ...
 * by the <code>CTabFolder2Listener</code> interface.
 * <p>
 * Classes that wish to deal with <code>CTabFolderEvent</code>s can extend this
...
public class CTabFolder2Adapter implements CTabFolder2Listener {
	 ...
	 * visible and to change the selection based on the item selected from the
	 * list.
	 * </p>
	 * 
	 * @param event
