 ...
 * </pre></code>
 * 
 * @see <a href="http://www.eclipse.org/swt/snippets/#treeeditor">TreeEditor
 *      snippets</a>
...
public class TreeEditor extends ControlEditor {
	...
	/**
	 * Returns the TreeItem for the row of the cell being tracked by this
	 * editor.
	 * 
	...
	void resize() {
		 ...
		 * visible at the bottom of the table is selected. Ensure that the
		 * correct row is edited by laying out one more time in a timerExec().
		 */
		if (tree != null) {
