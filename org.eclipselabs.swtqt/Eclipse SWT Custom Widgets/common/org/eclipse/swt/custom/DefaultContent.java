 ...
 * at least one empty line.
	 ...
	 *                <ul>
	 *                <li>ERROR_INVALID_ARGUMENT when the text change results in
	 *                a multi byte line delimiter being split or partially
	 *                deleted. Splitting a line delimiter by inserting text
	 *                between the CR and LF characters of the \r\n delimiter or
	 *                deleting part of this line delimiter is not supported</li>
	 *                </ul>
	 */
