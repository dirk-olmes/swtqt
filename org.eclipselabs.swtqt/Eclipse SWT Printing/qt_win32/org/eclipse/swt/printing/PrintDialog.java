...
public class PrintDialog extends Dialog {
	...
	public PrinterData open() {
		...
		//
		//		/*
		//		 * If user setup info from a previous print dialog was specified, then
		//		 * restore the previous DEVMODE struct.
		//		 */
		...
		//		devmode.dmOrientation = printerData.orientation == PrinterData.PORTRAIT ? OS.DMORIENT_PORTRAIT
		//				: OS.DMORIENT_LANDSCAPE;
		...
		//				data.orientation = dmOrientation == OS.DMORIENT_LANDSCAPE ? PrinterData.LANDSCAPE
