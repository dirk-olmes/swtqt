...
public final class Printer extends Device {
	...
	protected void create( DeviceData deviceData ) {
		...
		if ( devmodeData != null && devmodeData.length != 0 ) {
			/*
			 * If user setup info from a print dialog was specified, restore the
			 * DEVMODE struct.
			 */
	...
	public QPaintDeviceInterface internal_new_GC( GCData data ) {
		...
		// data.layout = (data.style & SWT.RIGHT_TO_LEFT) != 0 ? OS.LAYOUT_RTL :
		// 0;
		// } else {
		...
		// data.device = this;
		// // TODO
		// // data.font = Font.qt_new(this, OS.GetCurrentObject(handle,
		// OS.OBJ_FONT));
		// isGCCreated = true;
		// }
		// return handle;
