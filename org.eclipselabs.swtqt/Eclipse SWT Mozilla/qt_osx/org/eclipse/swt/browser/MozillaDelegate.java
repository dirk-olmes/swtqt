...
class MozillaDelegate {
	...
	int createBaseWindow(nsIBaseWindow baseWindow) {
		/*
		 * Feature of Mozilla on OSX. Mozilla replaces the OSX application menu
		 * whenever a browser's base window is created. The workaround is to
		 * restore the previous menu after creating the base window.
		 */
